...
export default function Page() {
  ...
  // teams are not fetched here because managers cannot add assets
  ...
  // manager should not be able to create assets from this page
              ...
              <div className="px-4 lg:px-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    {/* Add Asset removed for managers */}
                  </div>
                </div>
